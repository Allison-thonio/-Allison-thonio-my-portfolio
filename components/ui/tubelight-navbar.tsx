...
export function TubelightNavBar({ items, activeSection, onNavigate, className }: NavBarProps) {
    ...
    return (
        ...
        >
            <div className="flex items-center gap-3 bg-background/10 border border-border/40 backdrop-blur-xl py-1 px-1 rounded-full shadow-lg">
                {items.map((item) => {
